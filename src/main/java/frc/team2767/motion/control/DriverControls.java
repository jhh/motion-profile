package frc.team2767.motion.control;

import edu.wpi.first.wpilibj.Joystick;
import edu.wpi.first.wpilibj.buttons.JoystickButton;
import edu.wpi.first.wpilibj.command.Command;
import frc.team2767.motion.command.LogCommand;
import frc.team2767.motion.command.MotionCommand;
import frc.team2767.motion.command.ZeroGyroCommand;
...
public class DriverControls {
  ...
  DriverControls(int port) {
    ...
    new JoystickButton(joystick, Button.UP.id).whenPressed(new MotionCommand(0d, 100_000));
    new JoystickButton(joystick, Button.DOWN.id).whenPressed(new MotionCommand(180d, 100_000));
